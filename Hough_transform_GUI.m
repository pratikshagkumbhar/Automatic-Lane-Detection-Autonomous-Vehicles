...
title(ax2,'Hough Transform','Color','white');
...
while hasFrame(VideoFile)
    ...
    %% Display Hough Transform Correctly
    imshow(imadjust(rescale(H)),[],...
    'XData',T,...
    'YData',R,...
    'Parent',ax2);

xlabel(ax2,'Theta','Color','white');
ylabel(ax2,'Rho','Color','white');
